package com.muzi.easypicturebackend.aop;
...
public class AuthInterceptor {
    ...
    public Object doInterceptor(ProceedingJoinPoint joinPoint, AuthCheck authCheck) throws Throwable {
        ...
        UserRoleEnum mustRoleEnum = UserRoleEnum.getEnumByRoleName(mustRole);
        // 不需要权限，放行
        ...
        // 以下为：必须有该权限才通过
        // 获取当前用户具有的权限
        UserRoleEnum userRoleEnum = UserRoleEnum.getEnumByRoleName(loginUser.getUserRole());
        // 没有权限，拒绝
