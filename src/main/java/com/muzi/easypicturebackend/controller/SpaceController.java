...
import com.muzi.easypicturebackend.model.dto.space.*;
import com.muzi.easypicturebackend.model.entity.Space;
import com.muzi.easypicturebackend.model.entity.User;
import com.muzi.easypicturebackend.model.enums.SpaceLevelEnum;
...
public class SpaceController {
    ...
    @PostMapping("/update")
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    public BaseResponse<Boolean> updateSpace(@RequestBody SpaceUpdateRequest spaceUpdateRequest, HttpServletRequest
            request) {
    ...
    public BaseResponse<Boolean> editSpace(@RequestBody SpaceEditRequest spaceEditRequest, HttpServletRequest request) {
        ...
        spaceService.fillSpaceBySpaceLevel(space);
        // 注意将 list 转为 string
//        space.setTags(JSONUtil.toJsonStr(spaceEditRequest.getTags()));
        // 设置编辑时间
